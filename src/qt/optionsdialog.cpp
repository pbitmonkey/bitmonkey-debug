    ...
    mapper(nullptr)
{
    ...
    ui->bitmonkeyAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitmonkeyAtStartup);
    ...
    ui->bitmonkeyAtStartup->setToolTip(ui->bitmonkeyAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitmonkeyAtStartup->setText(ui->bitmonkeyAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openbitmonkeyConfButton->setToolTip(ui->openbitmonkeyConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new bitmonkeyUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitmonkeyAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openbitmonkeyConfButton_clicked()
{
