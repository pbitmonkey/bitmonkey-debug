...
#ifndef BITMONKEY_QT_SPLASHSCREEN_H
#define BITMONKEY_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. bitmonkey Core initialization
...
#endif // BITMONKEY_QT_SPLASHSCREEN_H
