    ...
    platformStyle(_platformStyle)
{
    ...
    // normal bitmonkey address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying bitmonkey address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &bitmonkeyAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
