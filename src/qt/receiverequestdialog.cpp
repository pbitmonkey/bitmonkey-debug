...
#include <config/bitmonkey-config.h> /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatbitmonkeyURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + bitmonkeyUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatbitmonkeyURI(info));
}
