...
//! Entry point for bitmonkeyApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &bitmonkeyApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for bitmonkeyGUI tests.
void AppTests::guiTests(bitmonkeyGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &bitmonkeyGUI::consoleShown, this, &AppTests::consoleTests);
