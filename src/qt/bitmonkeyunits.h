...
#ifndef BITMONKEY_QT_BITMONKEYUNITS_H
#define BITMONKEY_QT_BITMONKEYUNITS_H
...
/** bitmonkey unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class bitmonkeyUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit bitmonkeyUnits(QObject *parent);

    /** bitmonkey units.
      @note Source: https://en.bitmonkey.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTM,
...
typedef bitmonkeyUnits::Unit bitmonkeyUnit;

#endif // BITMONKEY_QT_BITMONKEYUNITS_H
