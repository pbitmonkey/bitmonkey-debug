...
#ifndef BITMONKEY_SCRIPT_STANDARD_H
#define BITMONKEY_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitmonkey address
 */
...
/**
 * Generate a bitmonkey scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITMONKEY_SCRIPT_STANDARD_H
