...
#ifndef BITMONKEY_TXMEMPOOL_H
#define BITMONKEY_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/bitmonkey/bitmonkey/pull/14193 will fix it. No known code
     * in bitmonkey currently depends on second guarantee, but it is important to
