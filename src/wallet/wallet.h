...
#ifndef BITMONKEY_WALLET_WALLET_H
#define BITMONKEY_WALLET_WALLET_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitmonkey from opening the wallet, thinking it was newly created, and
 ...
 * change.
 *
 * The bitmonkey Core wallet was originally a collection of unrelated private
...
public:
     ...
     * on this bitmonkey node, and set to 0 for transactions that were created
...
#endif // BITMONKEY_WALLET_WALLET_H
