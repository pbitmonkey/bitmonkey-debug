...
#ifndef BITMONKEY_KEYSTORE_H
#define BITMONKEY_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/bitmonkey/bips/blob/master/bip-0013.mediawiki
