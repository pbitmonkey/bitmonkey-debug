...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            + "If you are running the bitmonkey core wallet, you can get a new address to send the newly generated bitmonkey to with:\n"
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            RPCHelpMan{"getblocktemplate",
                ...
                "    https://github.com/bitmonkey/bips/blob/master/bip-0022.mediawiki\n"
                "    https://github.com/bitmonkey/bips/blob/master/bip-0023.mediawiki\n"
                "    https://github.com/bitmonkey/bips/blob/master/bip-0009.mediawiki#getblocktemplate_changes\n"
                "    https://github.com/bitmonkey/bips/blob/master/bip-0145.mediawiki\n",
                {
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2) {
        throw std::runtime_error(
            RPCHelpMan{"submitblock",
                ...
                "See https://en.bitmonkey.it/wiki/BIP_0022 for full specification.\n",
                {
