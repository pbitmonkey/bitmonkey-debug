/* src/config/bitmonkey-config.h.  Generated from bitmonkey-config.h.in by configure.  */
/* src/config/bitmonkey-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITMONKEY_CONFIG_H

#define BITMONKEY_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/bitmonkey/bitmonkey/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "bitmonkey Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "bitmonkey Core 0.18.99"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitmonkey"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitmonkeycore.org/"
