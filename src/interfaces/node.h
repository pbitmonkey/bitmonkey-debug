...
#ifndef BITMONKEY_INTERFACES_NODE_H
#define BITMONKEY_INTERFACES_NODE_H
...
//! Top-level interface for a bitmonkey node (bitmonkeyd process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITMONKEY_INTERFACES_NODE_H
