...
#ifndef BITMONKEY_TEST_SCRIPTNUM10_H
#define BITMONKEY_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from bitmonkey Core 0.10.0, for cross-comparison.
 */
public:
