// Copyright (c) 2012-2019 The bitmonkey Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.bitmonkeycore.org", "www.bitmonkeycore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitmonkeycore.org]", "www.bitmonkeycore.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitmonkeycore.org:80", "www.bitmonkeycore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitmonkeycore.org]:80", "www.bitmonkeycore.org", 80));
