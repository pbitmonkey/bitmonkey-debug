bitmonkey-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitmonkey/files/bitmonkey/bitmonkey-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the bitmonkey
...
New/changed settings (command-line or bitmonkey.conf file)
--------------------------------------------------------
