bitmonkey Core version 0.13.2 is now available from:
  ...
  <https://bitmonkey.org/bin/bitmonkey-core-0.13.2/>
...
- #8908 `4a974b2` Update bitmonkey-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitmonkey-tx to create v2 transactions (btmdrak)
