bitmonkey Core version 0.16.1 is now available from:

  <https://bitmonkeycore.org/bin/bitmonkey-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitmonkeyd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitmonkeyd processes are cleaned up when tests end (sdaftuar)
