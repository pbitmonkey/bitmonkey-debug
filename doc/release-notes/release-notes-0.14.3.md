bitmonkey Core version *0.14.3* is now available from:

  <https://bitmonkey.org/bin/bitmonkey-core-0.14.3/>
...
- #10451 `3612219` contrib/init/bitmonkeyd.openrcconf: Don't disable wallet by default (Luke Dashjr)
