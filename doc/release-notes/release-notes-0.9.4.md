bitmonkey Core version 0.9.4 is now available from:

  https://bitmonkey.org/bin/0.9.4/
...
this update is incompatible with the bitmonkey system and could lead to consensus
forks.

bitmonkey Core released binaries from https://bitmonkey.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitmonkey/+archive/ubuntu/bitmonkey
- A third-party or self-compiled bitmonkey Core

upgrade to bitmonkey Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
