bitmonkey Core version *0.15.2* is now available from:

  <https://bitmonkeycore.org/bin/bitmonkey-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in bitmonkey-tx (TheBlueMatt)
