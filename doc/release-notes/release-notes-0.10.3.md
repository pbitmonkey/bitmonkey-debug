bitmonkey Core version 0.10.3 is now available from:

  <https://bitmonkey.org/bin/bitmonkey-core-0.10.3/>
...
(see https://github.com/bitmonkey/bitmonkey/pull/6793, as well as the 0.11.0
