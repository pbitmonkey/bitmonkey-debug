bitmonkey Core version 0.16.0 is now available from:
  ...
  <https://bitmonkeycore.org/bin/bitmonkey-core-0.16.0/>
...
- #11917 `bc66765` Add testnet DNS seed:  seed.testnet.bitmonkey.sprovoost.nl (Sjors)
...
- #11970 `b7450cd` Add test coverage for bitmonkey-cli multiwallet calls (ryanofsky)
...
- #10997 `affe927` Add option -stdinrpcpass to bitmonkey-cli to allow RPC password to be read from standard input (jharvell)
...
- #11621 `1f7695b` [build] Add temp_bitmonkey_locale_qrc to CLEAN_QT to fix make distcheck (fanquake)
...
- #11711 `6378e5c` bitmonkey_qt.m4: Minor fixes and clean-ups (fanquake)
...
- #11297 `16e4184` Make sure ~/.bitmonkey doesn't exist before build (MeshCollider)
...
- #11143 `3aa60b7` Fix include path for bitmonkey-config.h (danra)
...
- #10871 `c9a4aa8` Handle getinfo in bitmonkey-cli w/ -getinfo (revival of #8843) (achow101)
- #11419 `093074b` Utils: Fix launchctl not being able to stop bitmonkeyd (OmeGak)
...
- #10529 `331352f` Improve bitmonkeyd systemd service file (Flowdalic)
