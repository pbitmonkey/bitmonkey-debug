bitmonkey Core version 0.10.4 is now available from:

  <https://bitmonkey.org/bin/bitmonkey-core-0.10.4/>
...
- #6953 `43c2789` Split bitmonkey-tx into its own package
- #6953 `dfe0d4d` Include bitmonkey-tx binary on Debian/Ubuntu
