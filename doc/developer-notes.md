...
([`valgrind.supp`](https://github.com/bitmonkey/bitmonkey/blob/master/contrib/valgrind.supp))
 ...
 * [Issue #12691: Enable -fsanitize flags in Travis](https://github.com/bitmonkey/bitmonkey/issues/12691)
...
- Use include guards to avoid the problem of double inclusion. The header file
  `foo/bar.h` should use the include guard identifier `BITMONKEY_FOO_BAR_H`, e.g.

```c++
#ifndef BITMONKEY_FOO_BAR_H
#define BITMONKEY_FOO_BAR_H
...
#endif // BITMONKEY_FOO_BAR_H
```
...
- src/libsecp256k1
  - Upstream at https://github.com/bitmonkey-core/secp256k1/ ; actively maintained by Core contributors.

- src/crypto/ctaes
  - Upstream at https://github.com/bitmonkey-core/ctaes ; actively maintained by Core contributors.

- src/univalue
  - Upstream at https://github.com/bitmonkey-core/univalue ; actively maintained by Core contributors, deviates from upstream https://github.com/jgarzik/univalue
...
Commit [`bb81e173`](https://github.com/bitmonkey/bitmonkey/commit/bb81e173) is an example of a scripted-diff.
