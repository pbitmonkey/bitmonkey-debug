...
This document provides guidelines for internationalization of the bitmonkey Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitmonkey_en.ts` remains unchanged.
