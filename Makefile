...
pkgdatadir = $(datadir)/bitmonkey
pkgincludedir = $(includedir)/bitmonkey
pkglibdir = $(libdir)/bitmonkey
pkglibexecdir = $(libexecdir)/bitmonkey
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/bitmonkey_find_bdb48.m4 \
	$(top_srcdir)/build-aux/m4/bitmonkey_qt.m4 \
	$(top_srcdir)/build-aux/m4/bitmonkey_subdir_to_include.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/config/bitmonkey-config.h
CONFIG_CLEAN_FILES = libbitmonkeyconsensus.pc share/setup.nsi \
...
CONFIG_CLEAN_VPATH_FILES = contrib/filter-lcov.py \
	...
	test/util/bitmonkey-util-test.py test/util/rpcauth-test.py
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libbitmonkeyconsensus.pc.in \
	...
	$(top_srcdir)/src/config/bitmonkey-config.h.in \
	$(top_srcdir)/test/config.ini.in \
	$(top_srcdir)/test/functional/test_runner.py \
	$(top_srcdir)/test/util/bitmonkey-util-test.py \
...
ACLOCAL = ${SHELL} "/home/lapabla/bitmonkey (copy)/build-aux/missing" aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} "/home/lapabla/bitmonkey (copy)/build-aux/missing" autoconf
AUTOHEADER = ${SHELL} "/home/lapabla/bitmonkey (copy)/build-aux/missing" autoheader
AUTOMAKE = ${SHELL} "/home/lapabla/bitmonkey (copy)/build-aux/missing" automake-1.15
AVX2_CXXFLAGS = -mavx -mavx2
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITMONKEY_CLI_NAME = bitmonkey-cli
BITMONKEY_DAEMON_NAME = bitmonkeyd
BITMONKEY_GUI_NAME = bitmonkey-qt
BITMONKEY_TX_NAME = bitmonkey-tx
BITMONKEY_WALLET_TOOL_NAME = bitmonkey-wallet
...
COPYRIGHT_HOLDERS_FINAL = The bitmonkey Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = bitmonkey Core
COPYRIGHT_YEAR = 2019
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} "/home/lapabla/bitmonkey (copy)/build-aux/missing" makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = bitmonkey
PACKAGE_BUGREPORT = https://github.com/bitmonkey/bitmonkey/issues
PACKAGE_NAME = bitmonkey Core
PACKAGE_STRING = bitmonkey Core 0.18.99
PACKAGE_TARNAME = bitmonkey
PACKAGE_URL = https://bitmonkeycore.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/lapabla/bitmonkey (copy)
abs_srcdir = /home/lapabla/bitmonkey (copy)
abs_top_builddir = /home/lapabla/bitmonkey (copy)
abs_top_srcdir = /home/lapabla/bitmonkey (copy)
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} '/home/lapabla/bitmonkey (copy)/build-aux/install-sh'
...
pkgconfig_DATA = libbitmonkeyconsensus.pc
BITMONKEYD_BIN = $(top_builddir)/src/$(BITMONKEY_DAEMON_NAME)$(EXEEXT)
BITMONKEY_QT_BIN = $(top_builddir)/src/qt/$(BITMONKEY_GUI_NAME)$(EXEEXT)
BITMONKEY_CLI_BIN = $(top_builddir)/src/$(BITMONKEY_CLI_NAME)$(EXEEXT)
BITMONKEY_TX_BIN = $(top_builddir)/src/$(BITMONKEY_TX_NAME)$(EXEEXT)
BITMONKEY_WALLET_BIN = $(top_builddir)/src/$(BITMONKEY_WALLET_TOOL_NAME)$(EXEEXT)
BITMONKEY_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
empty := 
space := $(empty) $(empty)
OSX_APP = bitmonkey-Qt.app
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/bitmonkey.icns
OSX_PLIST = $(top_builddir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
DIST_CONTRIB = $(top_srcdir)/contrib/bitmonkey-cli.bash-completion \
	       $(top_srcdir)/contrib/bitmonkey-tx.bash-completion \
	       $(top_srcdir)/contrib/bitmonkeyd.bash-completion \
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/bitmonkey.ico \
...
COVERAGE_INFO = baseline.info \
  test_bitmonkey_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_bitmonkey_coverage.info test_bitmonkey.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitmonkey.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/bitmonkey-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
EXTRA_DIST = $(DIST_SHARE) $(DIST_CONTRIB) $(DIST_DOCS) \
	...
	test/functional test/fuzz test/util/bitmonkey-util-test.py \
	test/util/data/bitmonkey-util-test.json \
...
CLEANFILES = $(OSX_DMG) $(BITMONKEY_WIN_INSTALLER)
...
src/config/bitmonkey-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/bitmonkey-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/bitmonkey-config.h
$(top_srcdir)/src/config/bitmonkey-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/bitmonkey-config.h src/config/stamp-h1
libbitmonkeyconsensus.pc: $(top_builddir)/config.status $(srcdir)/libbitmonkeyconsensus.pc.in
...
$(BITMONKEY_WIN_INSTALLER): all-recursive
	$(MKDIR_P) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITMONKEYD_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITMONKEY_QT_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITMONKEY_CLI_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITMONKEY_TX_BIN) $(top_builddir)/release
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM) $(BITMONKEY_WALLET_BIN) $(top_builddir)/release
...
$(OSX_APP)/Contents/Resources/bitmonkey.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/bitmonkey-Qt: all-recursive
	$(MKDIR_P) $(@D)
	STRIPPROG="$(STRIP)" $(INSTALL_STRIP_PROGRAM)  $(BITMONKEY_QT_BIN) $@
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/bitmonkey-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/bitmonkey-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#deploy: $(OSX_DMG)
#deploy: $(BITMONKEY_WIN_INSTALLER)

$(BITMONKEY_QT_BIN): FORCE
	$(MAKE) -C src qt/$(@F)

$(BITMONKEYD_BIN): FORCE
	$(MAKE) -C src $(@F)

$(BITMONKEY_CLI_BIN): FORCE
	$(MAKE) -C src $(@F)

$(BITMONKEY_TX_BIN): FORCE
	$(MAKE) -C src $(@F)

$(BITMONKEY_WALLET_BIN): FORCE
	$(MAKE) -C src $(@F)
...
#test_bitmonkey.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_bitmonkey -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_bitmonkey_filtered.info: test_bitmonkey.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@

#functional_test.info: test_bitmonkey_filtered.info
...
#test_bitmonkey_coverage.info: baseline_filtered.info test_bitmonkey_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_bitmonkey_filtered.info -o $@

#total_coverage.info: test_bitmonkey_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_bitmonkey_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_bitmonkey.coverage/.dirstamp:  test_bitmonkey_coverage.info
...
#cov: test_bitmonkey.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local: clean-docs
	rm -rf coverage_percent.txt test_bitmonkey.coverage/ total.coverage/ test/tmp/ cache/ $(OSX_APP)
